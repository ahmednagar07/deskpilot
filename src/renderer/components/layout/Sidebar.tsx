    ...
    <nav className="relative flex flex-col w-56 shrink-0" style={{ background: 'var(--t-sidebar-bg)' }}>
      ...
      <div className="py-4 px-3 space-y-0.5">
        ...
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.background = 'var(--t-sidebar-hover-bg)';
            e.currentTarget.style.color = 'var(--t-sidebar-text-active)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.background = 'transparent';
            e.currentTarget.style.color = 'var(--t-sidebar-text)';
          }}
        >
          <span style={{ color: 'var(--t-sidebar-icon)', transition: 'all 0.2s' }}>
            {theme === 'dark' ? (
  ...
  return (
    <button
      ...
      style={{
        ...
        background: isActive ? 'var(--t-sidebar-active-bg)' : 'transparent',
    ...
    >
      ...
      <span style={{
        color: isActive ? 'var(--t-sidebar-icon-active)' : 'var(--t-sidebar-icon)',
